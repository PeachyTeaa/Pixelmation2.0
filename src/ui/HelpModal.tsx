  ...
  return (
    <Modal open={open} title="Как это работает" onClose={onClose}>
      <section style={{ display: 'grid', gap: '0.75rem' }}>
        ...
        <p>
          Кнопка <strong>⟲</strong> в шапке открывает архив восстановления: там сами собой
          копятся последние 300 состояний работы, любое можно вернуть в редактор или скачать.
        </p>
        <p>
